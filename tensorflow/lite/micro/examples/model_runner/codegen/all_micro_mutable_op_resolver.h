...
constexpr int kNumberOperators = 200;

// all_micro_mutable_op_resolver is used to register all the Ops for the TFLM
// interpreter. This is ok when code size is not a concern from and
