...
-I$(GECKO_SDK_PATH)/platform/service/udelay/inc \
 -I$(GECKO_SDK_PATH)/platform/compute/nn/mvp/config \
 -I$(GECKO_SDK_PATH)/platform/compute/nn/mvp/inc \
 -I$(GECKO_SDK_PATH)/platform/compute/driver/mvp/config \
 -I$(GECKO_SDK_PATH)/platform/compute/driver/mvp/inc
